...
{		
	return Py_BuildValue("{s:s,s:s,s:s,s:s,s:s,s:s,s:n,s:n,s:n,s:O}",
						 ...
						 "serial_number",  getStringValue(devicePropertyDict, @"ICADeviceSerialNumberString"),
						 "type", getStringValue(devicePropertyDict, @"ICADeviceTypeKey"),
						 "user_custom_name", getStringValue(devicePropertyDict, @"ICAUserAssignedDeviceNameKey"),
						 "session_status",  getStringValue(devicePropertyDict, @"scannerSessionStatus"),
						 ...
						 "resolutions", getListOfStringsValue(devicePropertyDict, @"preferred resolutions"));
}
...
{
    [[NSAutoreleasePool alloc] init];
	//NSDictionary *dict = getDevicePropertyDictionary(1073741827);
	//getDeviceList();
    return 0;
}